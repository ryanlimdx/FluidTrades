...
Credits to [Twelve Data API on RapidAPI]([url](https://rapidapi.com/twelvedata/api/twelve-data1/)) which provided us with real time data on charts and prices of assets. 
